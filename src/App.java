        ...
        botaoDepositar.addActionListener(new java.awt.event.ActionListener(){
            public void actionPerformed(ActionEvent e){
                if(cliente.getSenha() == verificaSenha.getText()){
                    con.updatePoupanca((Double.parseDouble(getValor.getText()) + conta.getSaldo()), cliente.getId());
                }
            }
        });
            		...
            		if(rs.next()) {
            			...
            			if(bancoSenha.equals(loginSenha) ) {
                            ...
                            try {
                                ...
                                while(rsConta.next()){
                                    conta = new Conta(rsConta.getInt("numero"), rsConta.getString("pixnumero"), rsConta.getString("pixemail"), rsConta.getString("pixcpf"), rsConta.getInt("agencia"), rsConta.getInt("operacao"), rsConta.getDouble("saldo"), rsConta.getDouble("cheque"), rsConta.getInt("cliente"), rsConta.getInt("senha"));
                                }
