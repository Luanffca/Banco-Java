...
public class App {
	...
	public static void main(String[] args) {
        ...
        telaInicial InicioTela = new telaInicial();

        JPanel Iniciojanela = InicioTela.telaInicial();
        
        JPanel Entrar = new JPanel();
        JPanel Cadastrar = new JPanel();
        JPanel tpConta = new JPanel();
        JPanel TelaInicial = new JPanel();
        JPanel inicioDiretor = new JPanel();
        JPanel inicioGerente = new JPanel();
        JPanel inicioCliente = new JPanel();
        ...
        JButton depositarDiretor = botoes.botaoInicial(" Depositar",0, 180, TelaInicial, panelDepositar);
        JButton sacarDiretor = botoes.botaoInicial(" Sacar",0, 240, TelaInicial, panelSacar);
        JButton extratoDiretor = botoes.botaoInicial(" Extrato",0, 300, TelaInicial, panelExtrato);
        JButton transferirDiretor = botoes.botaoInicial(" Transferir",0, 360, TelaInicial, panelTransferir);
        JButton contaDiretor = botoes.botaoInicial(" Conta",0, 420, TelaInicial, panelTransferir);
        JButton CadastrarConta = botoes.botaoInicial(" Cadastrar conta",0, 480, TelaInicial, panelDepositar);
        JButton showFunci = botoes.botaoInicial(" Funcionários",0, 540, TelaInicial, panelExtrato);
        JButton EmprestimoDiretor = botoes.botaoInicial(" Emprestimo",0, 600, TelaInicial, panelExtrato);
        ...
        inicioDiretor.add(depositarDiretor);
        inicioDiretor.add(sacarDiretor);
        inicioDiretor.add(extratoDiretor);
        inicioDiretor.add(transferirDiretor);
        inicioDiretor.add(contaDiretor);

        // TELA INICIAL GERENTE

        JButton depositarGerente = botoes.botaoInicial(" Depositar",0, 180, TelaInicial, panelDepositar);
        JButton sacarGerente = botoes.botaoInicial(" Sacar",0, 240, TelaInicial, panelSacar);
        JButton extratoGerente = botoes.botaoInicial(" Extrato",0, 300, TelaInicial, panelExtrato);
        JButton transferirGerente = botoes.botaoInicial(" Transferir",0, 360, TelaInicial, panelTransferir);
        JButton Emprestimo = botoes.botaoInicial(" Empréstimo",0, 420, TelaInicial, panelTransferir);
        JButton minhaContaGerente = botoes.botaoInicial(" Conta",0, 480, TelaInicial, panelTransferir);
        JButton CriarConta = botoes.botaoInicial(" Cadastrar conta",0, 540, TelaInicial, panelDepositar);
        JButton ShowContas = botoes.botaoInicial(" Mostrar contas",0, 600, TelaInicial, panelSacar);
        ...
        inicioGerente.add(transferirGerente);
        inicioGerente.add(extratoGerente);
        inicioGerente.add(sacarGerente);
        inicioGerente.add(depositarGerente);

        // TELA INICIAL Cliente
        JButton depositar = botoes.botaoInicial(" Depositar",0, 210, TelaInicial, panelDepositar);
        JButton sacar = botoes.botaoInicial(" Sacar",0, 280, TelaInicial, panelSacar);
        JButton extrato = botoes.botaoInicial(" Extrato",0, 350, TelaInicial, panelExtrato);
        JButton transferir = botoes.botaoInicial(" Transferir",0, 420, TelaInicial, panelTransferir);
        JButton pix = botoes.botaoInicial(" Empréstimo",0, 490, TelaInicial, panelTransferir);
        JButton minhaConta = botoes.botaoInicial(" Conta",0, 560, TelaInicial, panelTransferir);
        ...
        TelaInicial.setBackground(corCinza);
        TelaInicial.setLayout(null);
        TelaInicial.setVisible(false);
        TelaInicial.add(sair);
        TelaInicial.add(bemVindo);
        TelaInicial.add(textos.textos(0, 50, 520, 20, corAzul, 0, 0, 0, 0, corAmarelo));
        TelaInicial.add(textos.textos(480, 160, 50, 700, Color.white, 0, 0, 0, 0, Color.white));
        TelaInicial.add(textos.textos(" Saldo:", 0, 70, 300, 50, 25, Color.black));
        TelaInicial.add(labelCheque);
        TelaInicial.add(chequeInicial);
        TelaInicial.add(textos.textos(0, 120, 520, 40, corAzul, 0, 0, 3, 0, Color.white));
        TelaInicial.add(saldoInicial);
        TelaInicial.add(campoInicial);
        TelaInicial.add(inicioCliente);
        TelaInicial.add(inicioGerente);
        TelaInicial.add(inicioDiretor);
        ...
        panelDepositar.add(botoes.botaoVoltar(panelDepositar, TelaInicial));
        ...
        panelSacar.add(botoes.botaoVoltar(panelSacar, TelaInicial));
        ...
        panelTransferir.add(botoes.botaoVoltar(panelTransferir, TelaInicial));
        panelTransferir.add(textos.textos(" Transferir ", 50, 0, 520, 50, 25, Color.white, corAzul, 0, 0, 3, 0, Color.white));
        //TELA EXTRATO
        JButton voltarExtrato = botoes.botaoVoltar(panelExtrato, TelaInicial);
        ...
        segueSaque.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                getSaque.setText("");
                VerificaSenha(TelaInicial, panelVerificaSenha, validar, verifica, 2);
            }
            @Override
            public void mouseEntered(java.awt.event.MouseEvent e) {
        ...
        segueDeposito.addActionListener(new java.awt.event.ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                getDeposito.setText("");
                VerificaSenha(TelaInicial, panelVerificaSenha, validar, verifica, 1);
            }
        });
            			...
            			if(bancoSenha.equals(loginSenha) ) {
                            ...
                            try {
                                while(rsCliente.next()) {
                                    cliente = new Cliente(rsCliente.getString("tipo"), rsCliente.getInt("id"), rsCliente.getString("nome"), rsCliente.getString("usuario"), rsCliente.getString("datanascimento"), rsCliente.getString("cpf"), rsCliente.getString("rg"), rsCliente.getString("endereco"), rsCliente.getString("cep"), rsCliente.getString("email"), rsCliente.getString("celular"), rsCliente.getString("senha"));
                                }
                            ...
                            try {
                                while(rsConta.next()){
                                    conta = new Conta(rsConta.getInt("numero"), rsConta.getInt("agencia"), rsConta.getString("operacao"), rsConta.getDouble("saldo"), rsConta.getDouble("cheque"), rsConta.getInt("cliente"), rsConta.getString("senha"));
                                }
                            ...
                            if(cliente.getTipo().equals("diretor")){
                                ...
                                if(cliente.getTipo().equals("gerente")){
                                    inicioGerente.setVisible(true);
                                }else inicioCliente.setVisible(true);
                            }
            ...
            public void actionPerformed(ActionEvent e){
                if(senhaConta.getText().equals("    ")){
                    ...
                    if(tituloCorrente.isSelected() || tituloPoupanca.isSelected()){
                        ...
                        con.Cadastra("cliente", getNome.getText(), getUsuario.getText(), getData.getText(), getCPF.getText(), getRG.getText(), getEndereco.getText(), getCEP.getText(), getEmail.getText(), getCelular.getText(), newSenha);
        ...
        Iniciojanela.setSize(janela.getSize());

        Container Pane = janela.getContentPane();
        Pane.add(Iniciojanela);
        Pane.add(tpConta);
    ...
    public static void VerificaSenha(JPanel TelaInicial, JPanel panelSenha, JButton validar, JFormattedTextField verifica, int funcao){
    ...
    public static void saca(){
        if(conta.getOperacao().equals("001")){
            if(ValorOperacao < conta.getSaldo()){
                ...
                con.InsereExtrato(conta.getNumero(), "Saque", ValorOperacao, conta.getCheque(), conta.getSaldo(), valorSaldo, " ");
                ...
                if(conta.getSaldo() <= 0){
                    ...
                    con.InsereExtrato(conta.getNumero(), "Saque", ValorOperacao, valorCheque, conta.getSaldo(), (conta.getSaldo() - ValorOperacao), "Utilização do cheque especial");
        ...
        if(conta.getOperacao().equals("001")){
            if(conta.getSaldo() < 0){
                ...
                if(valor > 300.0){
                    ...
                    con.InsereExtrato(conta.getNumero(), "Depósito",ValorOperacao, 300.0, conta.getSaldo(), (valor-300), " ");
                    ...
                    con.InsereExtrato(conta.getNumero(), "Depósito",ValorOperacao, valor, conta.getSaldo(), (conta.getSaldo() + (valor - conta.getCheque())), "Cobrança de crédito especial");
